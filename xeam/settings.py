"""
Django settings for xeam project.
...
SECRET_KEY = 'django-insecure-xhc67#*5m2zc!(1ps6*whcs%jdxag-e!l6@7k-pacnz5pjv*ux'
...
WSGI_APPLICATION = 'xeam.wsgi.application'
